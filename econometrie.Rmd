...
reg25 <-lm(dlnl1 ~  dlnrain30+ factor(year) - 1, data=city)
summary(reg25)
plot(reg25)
...
reg28 <- plm(dlnl1 ~ year + agidison + dlnrain30 + D_ag30 + hirain_extent_agH_dlnrain + hirain_extent_agE_dlnrain, data = city, model='random', index=c('agidison','year'))
summary(reg28)
